...
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    ...
    echo "----------------------------------------------------------"
    echo -e $cyan"    Create by           $white":" $red DARKDAYS&WORTEX$tp"
...
ctrl_c() {
echo -e "\n"
echo -e "[${blink}${yellow}*${tp}]$blue DARK&WORTEX hacktool Programini Tercih Ettiginiz Için Teşekkürler.💛  {DARKDAYS} :)$tp"
exit 0
}
...
echo -e "${blink}${lightgreen}  |$tp ${cyan}Günün Sözü              $white":" $red Hayat Buysa Ben Kodlarda saklıyım DARK DAYS!!🥀$tp ${blink}${lightgreen}     |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Instagram           $white":" $red DARK DAYS & WORTEX $tp ${blink}${lightgreen}                  |$tp"
echo -e "${blink}${lightgreen}  ---------------------------------------------------------$tp\n"
echo "  ~~~~~~~~~~~~~~~~~~~~~ DARK DAYS & WORTEX HackTool ~~~~~~~~~~~~~~~~~~~~~~~~~" 
	...
	echo " [13] ✔ RED_HAWK              [14] ✔ Ghost" 
        echo " [x] ✔ Exit" 
        echo ""
        echo -ne "❨${red}WORTEXHackTool@DARKDAYS${tp}❩:(${blue}./WORTEXhackTool${tp})\n↳[${blink}${lightcyan}*${tp}]➢ " ; read option
        ...
        case "$option" in 
            ...
            x)
                clear
                cat banners/bcbanner
                echo " DARKDAYS&WORTEX hacktool Programini Tercih Ettiginiz Icin Tesekkurler.💛 {DARKDAYS} !!" 
                echo ""
                exit 0
                ;;
        esac

...
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    ...
    echo "----------------------------------------------------------"
    echo -e $cyan"   📌KURUCU📌          $white":" $red 📌By DARK DAYS📌$tp"
    ...
    echo -e "$cyan    canımsın>            $white : $red 💛WORTEXX💛 $tp"
    echo -e "$cyan    Developper         $white : $red 🐱‍👤DARK DAYS🐱‍👤$tp"
    exit 0
...
echo -e "[${blink}${yellow}*${tp}]$blue DARK & WORTEX Programini Tercih Ettiginiz Icin Tesekkurler  {ByDARK} :)$tp"
exit 0
}
...
echo -e "${blink}${lightgreen}  |$tp ${cyan}Instagram           $white":" $red @wortex$tp ${blink}${lightgreen}                  |$tp"
echo -e "${blink}${lightgreen}  ---------------------------------------------------------$tp\n"
echo " ~~~~~~~~~~~~~~~~~~~~~ ByDarkDays Termux ~~~~~~~~~~~~~~~~~~~~~~~~~" 
        echo ""
        echo " [1] ✔ BluForce-FB" 
        echo " [2] ✔ Cupp" 
        echo " [3] ✔ SpamWa" 
        ...
        echo " [h] ✔ Help" 
        echo " [q] ✔ Exit"  
        echo -ne "\n${red}┌─[${tp}${USER}${yellow}@${blue}DarkHackTool${red}]─[${green}./Darkhacktool-termux.sh${red}] \n└──╼${yellow}$ ${tp}" ; read option
        echo ""
        ...
        case "$option" in
            ...
            q) 
                clear
                cat banners/bcbanner
                echo " DarkHackTool Programini Tercih Ettiginiz Icin Tesekkurler {🐱‍👤ByDarkDays🐱‍👤} !!" 
                echo ""
                exit 0
                ;;
        esac
